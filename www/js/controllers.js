...
angular.module('starter.controllers', ['ionic','chart.js','ngCookies'])
        ...
        .controller('LoginCtrl',function($scope,$state,$http,$ionicPopup,$ionicLoading,$timeout,$cookies,jpushService){
            ...
            $scope.login = function(){
                ...
                if($scope.user.phone != '' && $scope.user.password != ''){
                        ...
                        $http.get('http://10.0.1.3:3000/login', {params:{usertype: $scope.user.usertype, registerPhone: $scope.user.phone, password: $scope.user.password, username: $scope.user.phone}})
    ...
    .controller('RegisterCtrl',function($scope,$state,$ionicPopup,$ionicLoading,$http,$cookies,$timeout){
                ...
                $scope.register = function(){
                    if($scope.user.check_password == $scope.user.password){
                        //
                        $http({
                            url: 'http://10.0.1.3:3000/sessions',
                            method: "POST",
    ...
    .controller('RegisterPhoneCtrl', function($scope,$state,$http,$ionicLoading,$ionicPopup,$cookies,$timeout){
        ...
        $scope.getCode = function () {
            ...
            $http.get('http://10.0.1.3:3000/code', {params:{phone: $scope.user.registerPhone}})
                .success(function(data){
                    //
                    if(data == 'success'){
                        $ionicPopup.alert({
        ...
        $scope.nextFoot = function () {
            ...
            if($scope.user.registerPhone != '' && $scope.user.code != ''){
                ...
                //
                $http({
                    url: 'http://10.0.1.3:3000/codecheck',
                    method: "POST",
                    headers: {'Content-Type': 'application/x-www-form-urlencoded'},
    ...
    .controller('LetterCtrl', function ($scope,$state,$http,$ionicLoading,$ionicPopup,$cookies,$timeout) {
        ...
        $http.get('http://10.0.1.3:3000/letter', {params:{user: $cookies.user}})
            .success(function(data){
                //
                //alert(data.content);
                $scope.letter = data;
    ...
    .controller('AnnounCtrl',function($scope,$state,$ionicPopup,$http,$cookies,$ionicLoading,$timeout){
        ...
        $scope.$on('$ionicView.beforeEnter', function (viewInfo, state) {
            ...
            $http.get('http://10.0.1.3:3000/messageGet', {params:{user: $cookies.user}})
                .success(function(data){
                    //
                    $scope.message = data;
                    //
    ...
    .controller('QueryCtrl', function($scope,$state,$ionicPopup,$ionicLoading,$http,$cookies) {
        ...
        $scope.query = function() {
            if ($scope.user.select != '') {
                ...
                $http.get('http://10.0.1.3:3000/check', {
                    params: {
                    ...
                    .success(function (data) {
                        if(data == 'true') {
                            ...
                            //
                            $http({
                                url: 'http://10.0.1.3:3000/checkPay',
                                method: "POST",
                                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
    ...
    .controller('ResultsCtrl',function($scope,$state,$http,$cookies){
        //
        $http.get('http://10.0.1.3:3000/checkone',{
            params:{
    ...
    .controller('DormitoryCtrl', function($scope,$state,$ionicPopup,$http,$ionicLoading,$window,$cookies,$timeout) {
        ...
        $scope.$on('$ionicView.beforeEnter', function (viewInfo, state) {
            //
            $http({
                url: 'http://10.0.1.3:3000/DormCheckPay',
                method: "POST",
                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                ...
                //
                if(data == 0){
                    $http.get('http://10.0.1.3:3000/ProfessionIdGet', {params:{registerPhone: $cookies.user}})
                        .success(function(data){
                            //
                            $cookies.userInformation = data;
                            //
                            $http.get('http://10.0.1.3:3000/dorm', {params: {ProfessionId: data}})
                    ...
                    //
                    $http.get('http://10.0.1.3:3000/isChoose', {params:{user: $cookies.user}})
                        .success(function(data){
                            //
                            if(data){
                                //
                        ...
                        $http.get('http://10.0.1.3:3000/isChoose', {params:{user: $cookies.user}})
                            .success(function(data){
                                ...
                                if(data){
                                    ...
                                    //
                                    $http.get('http://10.0.1.3:3000/room', {params:{_id: value}})
                                        .success(function(data){
                                            //
                                            $ionicLoading.hide();
                                            //
                                            if(data.OrderDorm != 0){
                                                $ionicPopup.confirm({
                                                    ...
                                                    if(res == true){
                                                        ...
                                                        $http.get('http://10.0.1.3:3000/update', {params:{_id: value, phone: $cookies.user}})
                                                            .success(function(data){
                                                                //
                                                                $ionicLoading.hide();
                                                                //
        ...
        $scope.doRefresh = function(){
            ...
            $http.get('http://10.0.1.3:3000/dorm', {params: {ProfessionId: $cookies.userInformation}})
                .success(function(data){
                    //
                    $scope.users = data;
                    //
    ...
    .controller('InformationCtrl', function($scope,$ionicPopup,$http,$state,$cookies,$ionicLoading,$timeout) {
        ...
        $scope.$on('$ionicView.beforeEnter', function (viewInfo, state) {
            ...
            //
            $http.get('http://10.0.1.3:3000/stuone',{
                params:{
                ...
                .success(function(data){
                    $scope.student = data;
                    //
                    $http.get('http://10.0.1.3:3000/stuoneArea', {params:{AreaId: data.AreaId}})
                        .success(function(data2){
                            //
                            $scope.student.AreaId = data2.AreaName;
                        });
                    //
                    $http.get('http://10.0.1.3:3000/stuoneSex', {params:{user: $cookies.user}})
                    ...
                    //
                    $http.get('http://10.0.1.3:3000/studentIsReport', {params:{user: $cookies.user}})
...
// 教师-教师平台
    ...
    .controller('PlatCollegeCtrl', function ($scope,$stateParams,$state,$http,$timeout,$ionicLoading) {
        ...
        $http.get('http://10.0.1.3:3000/colleges')
            .success(function(data){
                $scope.colleges = data;
            }).error(function(){
                $timeout(function () {
    ...
    .controller('PlatprofessionCtrl', function ($scope,$stateParams,$state,$http,$ionicLoading,$timeout,$ionicPopup) {
        ...
        $http.get('http://10.0.1.3:3000/professions', {
    ...
    .controller('PlatclassCtrl', function ($scope,$stateParams,$state,$http,$ionicPopup,$ionicLoading,$timeout) {
        ...
        $http.get('http://10.0.1.3:3000/classes',{
            params:{
    ...
    .controller('PlatClassStusCtrl', function ($http,$scope,$stateParams,$ionicPopup,$ionicLoading,$timeout) {
        ...
        $http.get('http://10.0.1.3:3000/students', {
            params:{
                Clazz:$scope.Clazz,
    ...
    .controller('ClassMemberCtrl',function($scope,$stateParams,$http,$ionicLoading,$timeout,$ionicPopup){
        ...
        $http.get('http://10.0.1.3:3000/student', {
            params:{StudentID: $stateParams.StudentID}})
            .success(function(data){
                $scope.student = data;
                //
                $http.get('http://10.0.1.3:3000/studentDorm', {params:{DormId: data.DormId}})
                    .success(function(data2){
                        //
                ...
                //
                $http.get('http://10.0.1.3:3000/studentArea', {params:{AreaId: data.AreaId}})
                    .success(function(data2){
                        //
    ...
    .controller('PlatInformationCtrl', function ($scope,$state,$ionicPopup,$filter,$http,$ionicLoading,$timeout) {
        ...
        $scope.professionChoose = function(value){
            ...
            $http.get('http://10.0.1.3:3000/checkProfessionId', {params: {ProfessionName: value}})
                .success(function(data){
                    //
            ...
            //
            $http.get('http://10.0.1.3:3000/getClassNumber', {params:{ProfessionName: value}})
                .success(function(data){
                    //
                    var array1 = [];
        ...
        $scope.change = function(value){
            ...
            //    template: value
            //});
            $http.get('http://10.0.1.3:3000/getProfession', {params:{CollegeName: value}})
                .success(function(data){
                    //
                    //$scope.computer = data;
                    $scope.colleges = {
        ...
        $scope.send = function(){
            ...
            if($scope.ClassChoose == undefined){
                ...
                if($scope.message.title != '' && $scope.message.content != ''){
                    ...
                    $http({
                        url: 'http://10.0.1.3:3000/messageSend',
                        method: "POST",
                        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
    ...
    .controller('StaReportCtrl', function ($scope,$state,$window,$http,$cookies,$timeout,$ionicLoading,$ionicPopup) {
        ...
        $scope.$on('$ionicView.beforeEnter', function (viewInfo, state) {
            ...
            if($cookies.CollegeName == '全校'){
                ...
                // 全校 未报道
                $http.get('http://10.0.1.3:3000/checkIsReport', {params: {CollegeName: '全校', IsPay: 0}})
                    .success(function(data){
                        //
                        $scope.noreport = data;
                        // 全校 已报道
                        $http.get('http://10.0.1.3:3000/checkIsReport', {params: {CollegeName: '全校', IsPay: 1}})
                            .success(function(data){
                                //
                                $scope.reported = data;
                            }).error(function(){
                ...
                //查询已报道人数
                $http.get('http://10.0.1.3:3000/checkIsReport', {params:{CollegeName: $cookies.CollegeName, ProfessionName: $cookies.ProfessionName, IsPay: 1}})
                    .success(function(data){
                        //
                        $scope.reported = data;
                        // 查询未报道人数
                        $http.get('http://10.0.1.3:3000/checkIsReport', {params:{CollegeName: $cookies.CollegeName, ProfessionName: $cookies.ProfessionName, IsPay: 0}})
                            .success(function(data){
                                //
                                $scope.noreport = data;
                                //
    ...
    .controller('StaPayCtrl', function ($scope,$state,$http,$cookies,$timeout,$ionicLoading) {
        ...
        $scope.$on('$ionicView.beforeEnter', function (viewInfo, state) {
            ...
            if($cookies.CollegeName == '全校'){
                ...
                $scope.title = $cookies.CollegeName;
                // 全校 未缴费
                $http.get('http://10.0.1.3:3000/checkIsPay', {params: {CollegeName: '全校', IsPay: 0}})
                    .success(function(data){
                        //
                        $scope.noreport = data;
                        $http.get('http://10.0.1.3:3000/checkIsPay', {params: {CollegeName: '全校', IsPay: 1}})
                            .success(function(data){
                                //
                                $scope.reported = data;
                            }).error(function(){
                ...
                //查询已缴费人数
                $http.get('http://10.0.1.3:3000/checkIsPay', {params:{CollegeName: $cookies.CollegeName, ProfessionName: $cookies.ProfessionName, IsPay: 1}})
                    .success(function(data){
                        //
                        $scope.reported = data;
                        // 查询未缴费人数
                        $http.get('http://10.0.1.3:3000/checkIsPay', {params:{CollegeName: $cookies.CollegeName, ProfessionName: $cookies.ProfessionName, IsPay: 0}})
                            .success(function(data){
                                //
                                $scope.noreport = data;
                                //
    ...
    .controller('PersonCenterCtrl', function ($scope,$state,$http,$ionicPopup,$cookies,$ionicLoading,$timeout) {
        ...
        $scope.$on('$ionicView.beforeEnter', function (viewInfo, state) {
            ...
            $http.get('http://10.0.1.3:3000/teaone',{
                params:{
                ...
                .success(function(data){
                    $scope.teacher = data;
                    $http.get('http://10.0.1.3:3000/profession', {params:{ProfessionId: data.ProfessionId}})
        ...
        //
        //$http.get('http://localhost:3000/teacherInfors', {params:{appuser: appuser}})
    ...
    .controller('TeacherInformationEditCtrl', function ($scope,$state,$http,$timeout,$ionicLoading,$ionicPopup) {
        ...
        $scope.finish = function(){
            ...
            $http.get('http://10.0.1.3:3000/teacherInfors', {
                params:{
                    job: appuser,
        ...
        $scope.$on('$ionicView.beforeEnter', function (viewInfo, state) {
            ...
            $scope.submit = function () {
                if ($scope.teacher.lodpassword != '' && $scope.teacher.newpassword != '' && $scope.teacher.entnewpassword != '') {
                    ...
                    $http.get('http://10.0.1.3:3000/ChangePassword',{
                        params:{
    ...
    .controller('CheckStatisticsCtrl', function ($scope,$http,$state,$ionicPopup,$timeout,$window,$cookies,$ionicLoading) {
        ...
        $scope.collegeChoose = function(value){
            ...
            $http.get('http://10.0.1.3:3000/statistics', {params:{CollegeName: value}})
                .success(function(data){
                    data.unshift('全院');
                    $scope.colleges = {
                        "计算机学院": data,
        ...
        $scope.professionChoose = function(value){
            ...
            //$ionicLoading.show();
            $http.get('http://10.0.1.3:3000/countReport', {params: {ProfessionName: value}})
                .success(function(data){
                    //
